...
4. Les emails de `SUPER_ADMIN_EMAILS` ont accès complet à l'interface d'admin
5. Les emails de `VIEWER_ADMIN_EMAILS` ont un accès en lecture seule aux pages groupes et utilisateurs
