...
@router.post("/{group_id}/name", response_class=RedirectResponse)
async def update_group_name(
    ...
    """
    Allow admin to update a group's name.
    """
    if not isinstance(group_id, int) or group_id <= 0:
        raise HTTPException(
            status_code=400,
    ...
    await admin_service.update_group_name(group_id, group_name)
